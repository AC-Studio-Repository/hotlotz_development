...
class KycBuyerEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        \Log::channel('emailLog')->info('KycBuyerEmail data : '.print_r($data,true) );

        return $this->subject('Requesting Additional Information')->view('emails.user.kyc_buyer_email', $data);
    }
}
