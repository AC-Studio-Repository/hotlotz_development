...
class KycCompanySellerEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        \Log::channel('emailLog')->info('KycCompanySellerEmail data : '.print_r($data,true) );

        return $this->subject('Requesting Additional Information')->view('emails.user.kyc_company_seller_email', $data);
    }
}
