                ...
                <div class="col-md-4 mt-5 mb-2 offset-md-1 bg-danger p-0">
                    <div class="card p-3" style=" border-radius: 0px 0px 170px 0px;">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h4 class="text-center">{{ $data[$i]['buyer_ref'] }}</h4>
                            </div>
                        </div>
                        <h1 class="card-title text-center mt-4 mb-4">Thank you</h1>                        
                        <h3 class="card-title text-center">{{ $data[$i]['buyer_fullname'] }}</h3>
                        <p class="text-center mt-3">{{ \Illuminate\Support\Str::upper($data[$i]['title'] )}}</p>
                        ...
                        <h6 class="text-center mb-3"><b>{{ $data[$i]['sale_date'] }} | # {{ $data[$i]['item_number'] }} | # {{ $data[$i]['lot_number'] }}</b></h6>
