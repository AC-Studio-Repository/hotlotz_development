    ...
    <div class="card card-accent-secondary">
        ...
        <div class="card-header">
            ...
            <!-- <div class="card-actionbar">
                <a href="{{ route('auction_cms.auction_cmss.create') }}" class="btn btn-sm btn-outline-success float-right">
        ...
        <div class="card-footer">
            <a href="{{route('auction_cms.auction_cmss.editcontent')}}"><button class="btn btn-success">{{ __('Edit') }}</button></a>
