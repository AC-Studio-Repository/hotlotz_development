...
<div class="card card-accent-secondary">
        ...
        <div class="card-header">
            ...
            <div class="card-actionbar">
                ...
                <a href="{{ route('auction_results.auction_resultss.create') }}" class="btn btn-sm btn-outline-success float-right">
                    ...
                    {{ __('Create Auction Results Main') }}
                </a>
                @endcan
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="auction_results_banner_image" name="auction_results_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$auction_results_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_auction_results_image_ids" id="hide_auction_results_image_ids" value="{{  $auction_results->banner_image }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_auction_results_image_ids" id="hide_auction_results_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$auction_results_data->isEmpty()) ? $auction_results->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('title_header', (!$auction_results_data->isEmpty()) ? $auction_results->title_header : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$auction_results_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! json_decode($auction_results->title_blog) !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button class="btn btn-success" onclick="edit_content();">{{ __('Update Auction Results Main') }}</button>
...
<script>
 ...
 var item_initialpreview = '{{ $banner }}';
    ...
    $(document).ready(function() {
        ...
        $("#auction_results_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/auction_main_pages/bannerAuctionResultsUpload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_auction_results_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_auction_results_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_auction_results_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_auction_results_image_ids').val(hide_item_ids);
    ...
    function edit_content(){
        ...
        var banner_image = $('#hide_auction_results_image_ids').val();
        var caption = $('#caption').val();
        var title_header = $('#title_header').val();

        if (!$('#title_blog').summernote('isEmpty')){
            title_blog = JSON.stringify($('.summernote').eq(0).summernote('code'));
        }

        $.ajax({
            url: "/manage/auction_main_pages/updateAuctionResultsContent",
            type: 'post',
            ...
            success: function(response) {
                if(response.status == '1'){
                    window.location.href = "{{ route('auction_main_page.auction_main_pages.auctionResultsIndex')}}";
                }
            }
        });
    }
