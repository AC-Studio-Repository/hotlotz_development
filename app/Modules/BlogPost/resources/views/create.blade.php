...
@section('content')
    ...
    {!! Form::open(['route' => 'blog_post.blog_posts.store', 'autocomplete' => 'off', 'enctype'=>'multipart/form-data', 'class' => 'row', 'data-parsley-validate'=>'true']) !!}
        ...
        <div class="col-12 col-lg-12 col-xl-12">
            <div class="card card-accent-secondary">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('blog_post.blog_posts.index')}}" class="btn btn-link text-muted">{{ __('Cancel') }}</a>
                </div>
            </div>
        </div>
