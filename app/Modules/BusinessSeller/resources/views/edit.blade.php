...
<div class="card card-accent-secondary">
        ...
        {!! Form::model($blogs, ['route' => ['business_seller.business_sellers.updateContent'], 'method' => 'POST']) !!}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="business_seller_banner_image" name="business_seller_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$business_seller_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_business_seller_image_ids" id="hide_business_seller_image_ids" value="{{  $business_seller->banner_image }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_business_seller_image_ids" id="hide_business_seller_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$business_seller_data->isEmpty()) ? $business_seller->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('blog_header_1', (!$business_seller_data->isEmpty()) ? $business_seller->blog_header_1 : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$business_seller_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! $business_seller->blog_1 !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">{{ __('Update Business Seller') }}</button>
...
<script>
 ...
 var blog_count = {{ $blog_count }};
    ...
    $(document).ready(function() {
        ...
        $("#business_seller_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/business_sellers/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_business_seller_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_business_seller_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_business_seller_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_business_seller_image_ids').val(hide_item_ids);
