...
<div class="card card-accent-secondary">
        ...
        {!! Form::model($blogs, ['route' => ['careers.careerss.updateContent'], 'method' => 'POST']) !!}
            ...
            <input type="hidden" id="hid_backend_count" name="hid_backend_count" value="{{ $latest_id }}" />
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="careers_banner_image" name="careers_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$careers_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_careers_image_ids" id="hide_careers_image_ids" value="{{  $hide_careers_image_ids }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_careers_image_ids" id="hide_careers_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$careers_data->isEmpty()) ? $careers->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('blog_header_1', (!$careers_data->isEmpty()) ? $careers->blog_header_1 : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$careers_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! $careers->blog_1 !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">{{ __('Update Careers Main') }}</button>
...
<script>
 ...
 var blog_count = {{ $blog_count }};
    ...
    $(document).ready(function() {
        ...
        $("#careers_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/careerss/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_careers_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_careers_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_careers_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_careers_image_ids').val(hide_item_ids);
