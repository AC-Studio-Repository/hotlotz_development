...
namespace App\Modules\Category\Http\Repositories;
...
class CategoryRepository
{
    ...
    public function canDestroy($id) {
        return $this->category->where('id', $id)->doesntHave('childrens')->exists();
    }
    ...
    public function destroy($id, $type = 1) { // 1 - normal, 2 - force
        if ($type == 1) {
            ...
            return $this->category->withTrashed()->find($id)->forceDelete();
        }
    }

    public function restore($id) {
        return $this->category->withTrashed()->find($id)->restore();
    }
}