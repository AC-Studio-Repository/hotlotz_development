...
<div class="card card-accent-secondary">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="glossary_banner_image" name="glossary_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$glossary_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_glossary_image_ids" id="hide_glossary_image_ids" value="{{  $glossary->banner_image }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_glossary_image_ids" id="hide_glossary_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$glossary_data->isEmpty()) ? $glossary->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('blog_header_1', (!$glossary_data->isEmpty()) ? $glossary->blog_header_1 : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$glossary_data->isEmpty())
                            <textarea id="blog_one" name="blog_one" class="summernote">{!! json_decode($glossary->blog_1) !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button class="btn btn-success" onclick="edit_content();">{{ __('Update Glossary') }}</button>
...
<script>
 ...
 var item_initialpreview = '{{ $banner }}';
    ...
    $(document).ready(function() {
        ...
        $("#glossary_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/glossarys/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_glossary_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_glossary_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_glossary_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_glossary_image_ids').val(hide_item_ids);
    ...
    function edit_content(){
        ...
        var banner_image = $('#hide_glossary_image_ids').val();
        ...
        $.ajax({
            url: "/manage/glossarys/updateContent",
            type: 'post',
             data:{banner_image, caption, blog_header_1, blog_1, _token: _token },
            dataType: 'json',
            async: false,
            success: function(response) {
                if(response.status == '1'){
                    window.location.href = "{{ route('glossary.glossarys.infopage')}}";
                }
            }
        });
    }
