...
<div class="card card-accent-secondary">
        ...
        {!! Form::model($blogs, ['route' => ['home_content.home_contents.updateContent'], 'method' => 'POST']) !!}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="homecontent_banner_image" name="homecontent_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$home_content_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_homecontent_image_ids" id="hide_homecontent_image_ids" value="{{  $home_content->banner_image }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_homecontent_image_ids" id="hide_homecontent_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$home_content_data->isEmpty()) ? $home_content->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('blog_header_1', (!$home_content_data->isEmpty()) ? $home_content->blog_header_1 : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$home_content_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! $home_content->blog_1 !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">{{ __('Update Home Content') }}</button>
...
<script>
 ...
 var blog_count = {{ $blog_count }};
    ...
    $(document).ready(function() {
        ...
        $("#homecontent_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/home_contents/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_homecontent_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_homecontent_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_homecontent_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_homecontent_image_ids').val(hide_item_ids);
