...
<div class="card card-accent-secondary">
        ...
        {!! Form::model($blogs, ['route' => ['hotlotz_concierge.hotlotz_concierges.updateContent'], 'method' => 'POST']) !!}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="hotlotz_concierge_banner_image" name="hotlotz_concierge_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$hotlotz_concierge_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_hotlotzConcierge_image_ids" id="hide_hotlotzConcierge_image_ids" value="{{  $hotlotz_concierge->banner_image }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_hotlotzConcierge_image_ids" id="hide_hotlotzConcierge_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$hotlotz_concierge_data->isEmpty()) ? $hotlotz_concierge->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('blog_header_1', (!$hotlotz_concierge_data->isEmpty()) ? $hotlotz_concierge->blog_header_1 : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$hotlotz_concierge_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! $hotlotz_concierge->blog_1 !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">{{ __('Update Estate Services') }}</button>
...
<script>
 ...
 var blog_count = {{ $blog_count }};
    ...
    $(document).ready(function() {
        ...
        $("#hotlotz_concierge_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/hotlotz_concierges/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_hotlotzConcierge_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_hotlotzConcierge_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_hotlotzConcierge_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_hotlotzConcierge_image_ids').val(hide_item_ids);
