...
<div class="card card-accent-secondary">
        ...
        {!! Form::model($blogs, ['route' => ['how_to_sell.how_to_sells.updateContent'], 'method' => 'POST']) !!}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="howtosell_banner_image" name="howtosell_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$how_to_sell_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_howtosell_image_ids" id="hide_howtosell_image_ids" value="{{  $how_to_sell->banner_image }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_howtosell_image_ids" id="hide_howtosell_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$how_to_sell_data->isEmpty()) ? $how_to_sell->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('blog_header_1', (!$how_to_sell_data->isEmpty()) ? $how_to_sell->blog_header_1 : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$how_to_sell_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! $how_to_sell->blog_1 !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">{{ __('Update How To Sell') }}</button>
...
<script>
 ...
 var blog_count = {{ $blog_count }};
    ...
    $(document).ready(function() {
        ...
        $("#howtosell_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/how_to_sells/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_howtosell_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_howtosell_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_howtosell_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_howtosell_image_ids').val(hide_item_ids);
