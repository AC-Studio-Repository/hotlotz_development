...
@section('content')
    ...
    <div class="card card-accent-secondary">
        ...
        {!! Form::model($main_banners, ['route' => ['marketplace_home.marketplace_homes.store_collaboration_info'], 'method' => 'POST']) !!}
                ...
                <div class="row" id="toggle_div_{{ $banner_count }}">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            {{ Form::text('header_title_'.$banner_count, null, [
                                    'class' => 'form-control form-control-md' . ($errors->has('header_title_'.$banner_count) ? ' is-invalid' : ''),
                                    'placeholder' => __('Image Caption')
                                ])
                            }}

                            @if ($errors->has('header_title_'.$banner_count))
                                <div class="invalid-feedback">{{ $errors->first('header_title_'.$banner_count) }}</div>
                            @endif
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            {{ Form::text('slogan_'.$banner_count, null, [
                                    'class' => 'form-control form-control-md' . ($errors->has('slogan_'.$banner_count) ? ' is-invalid' : ''),
                                    'placeholder' => __('Title Header')
                                ])
                            }}

                            @if ($errors->has('slogan_'.$banner_count))
                                <div class="invalid-feedback">{{ $errors->first('slogan_'.$banner_count) }}</div>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                @foreach($main_banners as $banner)
                    <div class="row" id="toggle_caption_{{ $banner->id }}">
                        <div class="col-md-6">
                            <label>{{ __('Image Caption') }}</label>
                            <div class="form-group">
                                {{ Form::text('header_title_'.$banner->id, $banner->header_title, [
                                        'class' => 'form-control form-control-md' . ($errors->has('header_title_'.$banner->id) ? ' is-invalid' : ''),
                                        'placeholder' => __('Image Caption')
                                    ])
                                }}

                                @if ($errors->has('header_title_'.$banner->id))
                                    <div class="invalid-feedback">{{ $errors->first('header_title_'.$banner->id) }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label>{{ __('Slogan') }}</label>
                            <div class="form-group">
                                {{ Form::text('slogan_'.$banner->id, $banner->slogan, [
                                        'class' => 'form-control form-control-md' . ($errors->has('slogan_'.$banner->id) ? ' is-invalid' : ''),
                                        'placeholder' => __('Slogan')
                                    ])
                                }}

                                @if ($errors->has('slogan_'.$banner->id))
                                    <div class="invalid-feedback">{{ $errors->first('slogan_'.$banner->id) }}</div>
                                @endif
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function initialize_file_upload(banner_count, id, previewImage)
    {
        ...
        $("#banner_"+id).fileinput({
            theme: "fas",
            uploadUrl: '/manage/marketplace_homes/collaboration_banner_upload',
            uploadAsync: true,
    ...
    function add_new_banner()
    {
        ...
        append_html = '<div class="row" id="toggle_caption_'+latest_id+'">'+
                '<div class="col-md-6">'+
                    "<label>{{ __('Image Caption') }}</label>"+
                    '<div class="form-group">'+
                        '<input type="text" id="header_title_'+latest_id+'" name="header_title_'+latest_id+'" value="" class="form-control form-control-md" placeholder="Title Header" />'+
                    '</div>'+
                '</div>';

        append_html += '<div class="col-md-6">'+
                    "<label>{{ __('Slogan') }}</label>"+
                    '<div class="form-group">'+
                        '<input type="text" id="header_title_'+latest_id+'" name="header_title_'+latest_id+'" value="" class="form-control form-control-md" placeholder="Title Header" />'+
                    '</div>'+
