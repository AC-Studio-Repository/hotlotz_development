...
namespace App\Modules\MarketplaceHomeBanner\Http\Repositories;

use App\Modules\MarketplaceHomeBanner\Models\MarketplaceHomeBanner;

class MarketplaceHomeBannerRepository
{
    public function __construct(MarketplaceHomeBanner $home_page) {
