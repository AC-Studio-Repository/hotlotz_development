...
<div class="card card-accent-secondary">
    ...
    {!! Form::model($media_resource, ['route' => ['media_resource.media_resources.update', $media_resource], 'method' => 'PUT']) !!}
    ...
    <div class="card-footer">
        <button class="btn btn-primary">{{ __('Update Media Resource') }}</button>
...
<script type="text/javascript">
    ...
    var item_initialpreview = '{{ $hide_media_resource_doc_ids }}';

    $(function(){

         //#Media Resource Document
