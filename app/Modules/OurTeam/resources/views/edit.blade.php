...
@section('title')
    {{ __('Editing') }} {{ $our_team->name }}
@stop

@section('content')

    {!! Form::model($our_team, ['route'  => ['our_team.our_teams.update', $our_team], 'method' => 'PUT',  'enctype'=>'multipart/form-data', 'data-parsley-validate'=>'true'])
    !!}
        <div class="col-12 col-lg-12 col-xl-12">
            <div class="card card-accent-secondary">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('our_team.our_teams.show',['our_team'=>$our_team])}}" class="btn btn-link text-muted">{{ __('Cancel') }}</a>
                </div>
            </div>
        </div>
