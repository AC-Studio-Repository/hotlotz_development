...
<div class="card card-accent-secondary">
        ...
        {!! Form::model($our_team, ['route' => ['our_team.our_teams.updateContent'], 'method' => 'POST']) !!}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="team_banner_image" name="team_banner_image" type="file" accept="image/*">
                        </div>

                        @if(!$our_team_data->isEmpty())
                            <input type="text" style="display: none;" name="hide_team_info_image_ids" id="hide_team_info_image_ids" value="{{  $hide_team_info_image_ids }}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @else
                            <input type="text" style="display: none;" name="hide_team_info_image_ids" id="hide_team_info_image_ids" value="" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload banner image!">
                        @endif
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$our_team_data->isEmpty()) ? $our_team->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('title_header', (!$our_team_data->isEmpty()) ? $our_team->title_header : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$our_team_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! $our_team->title_blog !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">{{ __('Update Our Team Main') }}</button>
...
<script>
 ...
 var item_initialpreview = '{{ $banner }}';
    ...
    $(document).ready(function() {
        ...
        $("#team_banner_image").fileinput({
            theme: "fas",
            uploadUrl: '/manage/our_teams/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_team_info_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_team_info_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_team_info_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_team_info_image_ids').val(hide_item_ids);
