...
<div class="card card-accent-secondary">
    ...
    {!! Form::model($blogs, ['route' => ['professional_valuation.professional_valuations.updateContent'], 'method' => 'POST']) !!}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12 col-xl-12">
                        ...
                        <div class="file-loading">
                            <input id="professional_valuations_banner" name="professional_valuations_banner" type="file" accept="image/*">
                        </div>

                        <input type="text" style="display: none;" name="hide_professional_valuations_image_ids" id="hide_professional_valuations_image_ids" value="{{$hide_image_ids}}" data-parsley-required="false" data-parsley-errors-container="#error_uploaded_item_images_block" data-parsley-required-message="Please select and upload at least one banner image!">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('caption', (!$professional_valuations_data->isEmpty()) ? $professional_valuations->caption : null, [
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            {{ Form::text('blog_header_1', (!$professional_valuations_data->isEmpty()) ? $professional_valuations->title : null, [
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(!$professional_valuations_data->isEmpty())
                            <textarea id="title_blog" name="title_blog" class="summernote">{!! $professional_valuations->blog !!}</textarea>
                        @else
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">{{ __('Update Professional Valuations') }}</button>
...
<script>
 ...
 var blog_count = {{ $blog_count }};
    ...
    $(document).ready(function() {
        ...
        $("#professional_valuations_banner").fileinput({
            theme: "fas",
            uploadUrl: '/manage/professional_valuations/banner_image_upload',
            uploadAsync: true,
            ...
            if(data.response.ids){
                ...
                var hide_item_ids_val = $("#hide_professional_valuations_image_ids").val();
                hide_item_ids_val += data.response.ids[0] + ',';
                $('#hide_professional_valuations_image_ids').val(data.response.saved_filepath);
            }
        ...
        .on("filedeleted", function(event,key,data) {
            ...
            var hide_item_ids = $("#hide_professional_valuations_image_ids").val();
            hide_item_ids = hide_item_ids.replace((item_img_id + ','),'');
            $('#hide_professional_valuations_image_ids').val(hide_item_ids);
