...
<div class="card card-accent-secondary">
    ...
    {!! Form::model($items, ['id'=>"itemFilterForm", 'route'  => ['report.reports.one_tree_planted_filter'], 'method' => 'POST', 'data-parsley-validate'=>"true"]) !!}
            ...
            <div class="col-12 col-md-10 col-xl-10 mt-2">
                <div class="btn-group float-right ml-3">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" onclick="download_table_as_csv('one_tree_planted');" href="#">CSV</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card-block" id="divItemList">
        @include('report::extends.one_tree_planted_table')
    </div>
...
<script>
    ...
    {
        var url = "/manage/reports/one_tree_planted_filter";
        if(page != null){
            url = "/manage/reports/one_tree_planted_filter?page="+page;
        }
        $.ajax({
            url:url,
            type: 'post',
