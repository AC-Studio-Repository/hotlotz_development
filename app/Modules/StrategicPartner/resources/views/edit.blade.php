...
<div class="card card-accent-secondary">
    ...
    {!! Form::model($strategic_partner, ['route' => ['strategic_partner.strategic_partners.update', $strategic_partner], 'method' => 'PUT']) !!}
    ...
    <div class="card-footer">
        <button class="btn btn-primary">{{ __('Update Strategic Partner') }}</button>
