...
@section('title')
    {{ __('Create New Highlight') }}
@stop

@section('content')

    {!! Form::open(['route' => ['what_we_sell.what_we_sells.highlight_store', $what_we_sell], 'autocomplete' => 'off', 'enctype'=>'multipart/form-data', 'class' => 'row', 'data-parsley-validate'=>'true']) !!}
