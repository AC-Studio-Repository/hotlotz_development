...
<div class="card card-accent-secondary">
    @php
        $route = 'whats_new_article_one.whats_new_article_ones.store';
        $method = "POST";
        if($id > 0){
            $route = ['whats_new_article_one.whats_new_article_ones.update', $whats_new_article_one];
            $method = "PUT";
        }
    @endphp
