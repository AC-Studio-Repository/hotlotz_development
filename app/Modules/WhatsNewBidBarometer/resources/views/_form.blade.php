<div class="form-row">
    <div class="form-group col-12 col-md-6 col-xl-6">
        ...
        {{ Form::text('title', old('title', $whats_new_bid_barometer->title ?? null), [
...
<div class="row">
    <div class="form-group col-12 col-md-6 col-xl-6">
        ...
        {{ Form::text('link', old('link', $whats_new_bid_barometer->link ?? null), [
    ...
    <div class="col-12 col-md-12 col-xl-12">
        ...
        <div class="form-group">
            <div style="height:0px;overflow:hidden;">
                <input name="bid_barometer_image" id="image_input" value="{{ old('bid_barometer_image',$whats_new_bid_barometer->full_path ?? '') }}" type="file" class="form-control" accept="image/*" onchange="readImage(this);" data-parsley-errors-container='#error_image_block' {{ !isset($whats_new_bid_barometer->full_path)?'required':null }} />
            </div>
