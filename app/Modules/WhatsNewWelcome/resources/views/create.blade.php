...
@section('title')
    {{ __("Create New What's New Welcome") }}
@stop

@section('content')

    {!! Form::open(['route' => 'whats_new_welcome.whats_new_welcomes.store', 'autocomplete' => 'off', 'enctype'=>'multipart/form-data', 'class' => 'row', 'data-parsley-validate'=>'true']) !!}
        ...
        <div class="col-12 col-lg-12 col-xl-12">
            <div class="card card-accent-secondary">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('whats_new_welcome.whats_new_welcomes.index')}}" class="btn btn-link text-muted">{{ __('Cancel') }}</a>
                </div>
            </div>
        </div>
