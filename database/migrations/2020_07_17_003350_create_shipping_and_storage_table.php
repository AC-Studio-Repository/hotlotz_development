...
class CreateShippingAndStorageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('shipping_and_storage', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('shipping_and_storage');
    }
}
